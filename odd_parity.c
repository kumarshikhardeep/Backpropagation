...
trained the feed-forward neural network for N bit odd parity.
There is 1 input layer which can contain any number of input neurons as per the user's choice,
1 hidden layer which can contain any number of neurons as well as per the user's choice
...
the neural network to detect the odd parity input and gives the output close to 1 if true and close to 0 if false.
*/
#include <stdio.h>
#include <math.h>
#include <stdlib.h>
