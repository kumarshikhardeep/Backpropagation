...
trained the feed-forward neural network for XOR.
There is 1 input layer containing 2 input neurons, 1 hidden layer containing 2 neurons
...
void main(){
	...
	data[0].input[0]=0.01; data[0].input[1]=0.01; data[0].teach[0]=0.01;
	data[1].input[0]=0.01; data[1].input[1]=0.99; data[1].teach[0]=0.99;
	data[2].input[0]=0.99; data[2].input[1]=0.01; data[2].teach[0]=0.99;
	data[3].input[0]=0.99; data[3].input[1]=0.99; data[3].teach[0]=0.01;
